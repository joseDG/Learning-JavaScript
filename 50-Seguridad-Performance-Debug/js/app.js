...
function selectCriptomonedas(criptomonedas) {
    ...
    //Esta parte se puede verificar el performace 
    // Conocer el tiempo de ejecución
    //se mide el timepo de ejecucio para poder ser ahcer mas rtapdio la web. 
    //const incio = performance.now();
     ...
     //este codigo reduce el timepo de ejecucion en una API. 
...
function consultarAPI() {
    ...
    //se puede medir cuanto tiempo se demora en cargar el appi 
...
function mostrarCotizacionHTML(cotizacion) {
    ...
    //aparte del console.log 
    //se puede utilziar el debuger.
    //para verificar dodne es el problema.  
    //debugger;
