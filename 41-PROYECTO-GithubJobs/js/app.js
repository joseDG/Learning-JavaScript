...
function consultarAPI(busqueda) {
    ...
    //se te utiliza un proxi para poder utrilizar la api y no salga el error del corns 'allorigins.win'
    const url = `https://api.allorigins.win/get?url=${ encodeURIComponent(githubUrl) }`;

    //axios es una libreria de javascript. 
    //axios es como un fetch Api pero mejorado 
    //axios simpre te va a retornoar en data. mem toca comvertirlo
    axios.get(url)
