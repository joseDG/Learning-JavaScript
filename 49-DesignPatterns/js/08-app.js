//Creacion del Mediator.
//SE COMUNICA CON DIFERENTES OBJETOS ALA VEZ PARA OBJTEIVCOS ESPECIFICOS. 
...
function Comprador(nombre) {
    this.nombre = nombre;
    //se pone la vartiable null proque en la parte de la subasta cuando se venda alga se va a llenar. 
    this.sala = null;
}
...
//esta funcion se comunica con el vendedor y comprador. 
function Subasta() {
    let compradores = {};
